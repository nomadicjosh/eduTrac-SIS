...
$app->match('GET|POST', '/install/createAdmin/', function () use($app) {
    ...
    if ($app->req->isPost()) {
        ...
        if ($connect) {
            ...
            $sql[] = "INSERT INTO `options_meta` VALUES(9, 'enable_cron_log', '0');";

            $sql[] = "INSERT INTO `options_meta` VALUES(10, 'current_term_code', '');";
            ...
            $sql[] = "INSERT INTO `options_meta` VALUES(17, 'room_request_text', '<p>&nbsp;</p>\r\n<table border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#F4F3F4\">\r\n<tbody>\r\n<tr>\r\n<td style=\"padding: 15px;\"><center>\r\n<table width=\"550\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" bgcolor=\"#ffffff\">\r\n<tbody>\r\n<tr>\r\n<td align=\"left\">\r\n<div style=\"border: solid 1px #d9d9d9;\">\r\n<table id=\"header\" style=\"line-height: 1.6; font-size: 12px; font-family: Helvetica, Arial, sans-serif; border: solid 1px #FFFFFF; color: #444;\" border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#ffffff\">\r\n<tbody>\r\n<tr>\r\n<td style=\"color: #ffffff;\" colspan=\"2\" valign=\"bottom\" height=\"30\">.</td>\r\n</tr>\r\n<tr>\r\n<td style=\"line-height: 32px; padding-left: 30px;\" valign=\"baseline\"><span style=\"font-size: 32px;\">eduTrac ERP</span></td>\r\n<td style=\"padding-right: 30px;\" align=\"right\" valign=\"baseline\"><span style=\"font-size: 14px; color: #777777;\">Room/Event Reservation Request</span></td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<table id=\"content\" style=\"margin-top: 15px; margin-right: 30px; margin-left: 30px; color: #444; line-height: 1.6; font-size: 12px; font-family: Arial, sans-serif;\" border=\"0\" width=\"490\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#ffffff\">\r\n<tbody>\r\n<tr>\r\n<td style=\"border-top: solid 1px #d9d9d9;\" colspan=\"2\">\r\n<div style=\"padding: 15px 0;\">Below are the details of a new room request.</div>\r\n<div style=\"padding: 15px 0;\"><strong>Name:</strong> #name#<br /><br /><strong>Email:</strong> #email#<br /><br /><strong>Event Title:</strong> #title#<br /><strong>Description:</strong> #description#<br /><strong>Request Type:</strong> #request_type#<br /><strong>Category:</strong> #category#<br /><strong>Room#:</strong> #room#<br /><strong>Start Date:</strong> #firstday#<br /><strong>End Date:</strong> #lastday#<br /><strong>Start Time:</strong> #sTime#<br /><strong>End Time:</strong> #eTime#<br /><strong>Repeat?:</strong> #repeat#<br /><strong>Occurrence:</strong> #occurrence#<br /><br /><br />\r\n<h3>Legend</h3>\r\n<ul>\r\n<li>Repeat - 1 means yes it is an event that is repeated</li>\r\n<li>Occurrence - 1 = repeats everyday, 7 = repeats weekly, 14 = repeats biweekly</li>\r\n</ul>\r\n</div>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<table id=\"footer\" style=\"line-height: 1.5; font-size: 12px; font-family: Arial, sans-serif; margin-right: 30px; margin-left: 30px;\" border=\"0\" width=\"490\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#ffffff\">\r\n<tbody>\r\n<tr style=\"font-size: 11px; color: #999999;\">\r\n<td style=\"border-top: solid 1px #d9d9d9;\" colspan=\"2\">\r\n<div style=\"padding-top: 15px; padding-bottom: 1px;\">Powered by eduTrac ERP</div>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style=\"color: #ffffff;\" colspan=\"2\" height=\"15\">.</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n</div>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n</center></td>\r\n</tr>\r\n</tbody>\r\n</table>');";

            $sql[] = "INSERT INTO `options_meta` VALUES(18, 'room_booking_confirmation_text', '<p>&nbsp;</p>\r\n<table border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#F4F3F4\">\r\n<tbody>\r\n<tr>\r\n<td style=\"padding: 15px;\"><center>\r\n<table width=\"550\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" bgcolor=\"#ffffff\">\r\n<tbody>\r\n<tr>\r\n<td align=\"left\">\r\n<div style=\"border: solid 1px #d9d9d9;\">\r\n<table id=\"header\" style=\"line-height: 1.6; font-size: 12px; font-family: Helvetica, Arial, sans-serif; border: solid 1px #FFFFFF; color: #444;\" border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#ffffff\">\r\n<tbody>\r\n<tr>\r\n<td style=\"color: #ffffff;\" colspan=\"2\" valign=\"bottom\" height=\"30\">.</td>\r\n</tr>\r\n<tr>\r\n<td style=\"line-height: 32px; padding-left: 30px;\" valign=\"baseline\"><span style=\"font-size: 32px;\">eduTrac ERP</span></td>\r\n<td style=\"padding-right: 30px;\" align=\"right\" valign=\"baseline\"><span style=\"font-size: 14px; color: #777777;\">Room/Event&nbsp;Booking&nbsp;Confirmation</span></td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<table id=\"content\" style=\"margin-top: 15px; margin-right: 30px; margin-left: 30px; color: #444; line-height: 1.6; font-size: 12px; font-family: Arial, sans-serif;\" border=\"0\" width=\"490\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#ffffff\">\r\n<tbody>\r\n<tr>\r\n<td style=\"border-top: solid 1px #d9d9d9;\" colspan=\"2\">\r\n<div style=\"padding: 15px 0;\">Your room request or event request entitled <strong>#title#</strong> has been booked. If you have any questions or concerns, please email our office at <a href=\"mailto:request@bdci.edu\">request@bdci.edu</a></div>\r\n<div style=\"padding: 15px 0;\">Sincerely,<br />Room Scheduler</div>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<table id=\"footer\" style=\"line-height: 1.5; font-size: 12px; font-family: Arial, sans-serif; margin-right: 30px; margin-left: 30px;\" border=\"0\" width=\"490\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#ffffff\">\r\n<tbody>\r\n<tr style=\"font-size: 11px; color: #999999;\">\r\n<td style=\"border-top: solid 1px #d9d9d9;\" colspan=\"2\">\r\n<div style=\"padding-top: 15px; padding-bottom: 1px;\">Powered by eduTrac ERP</div>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style=\"color: #ffffff;\" colspan=\"2\" height=\"15\">.</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n</div>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n</center></td>\r\n</tr>\r\n</tbody>\r\n</table>');";

            $sql[] = "INSERT INTO `options_meta` VALUES(19, 'myet_welcome_message', '<p>Welcome to the <em>my</em>eduTrac campus portal. The <em>my</em>eduTrac campus portal&nbsp;is your personalized campus web site at Eastbound University.</p>\r\n<p>If you are a prospective student who is interested in applying to the college, checkout the <a href=\"pages/?pg=admissions\">admissions</a>&nbsp;page for more information.</p>');";

            $sql[] = "INSERT INTO `options_meta` VALUES(20, 'contact_phone', '888.888.8888');";

            $sql[] = "INSERT INTO `options_meta` VALUES(21, 'contact_email', 'contact@colegio.edu');";

            $sql[] = "INSERT INTO `options_meta` VALUES(22, 'mailing_address', '10 Eliot Street, Suite 2\r\nSomerville, MA 02140');";

            $sql[] = "INSERT INTO `options_meta` VALUES(23, 'enable_myet_portal', '0');";

            $sql[] = "INSERT INTO `options_meta` VALUES(24, 'screen_caching', '1');";

            $sql[] = "INSERT INTO `options_meta` VALUES(25, 'db_caching', '1');";

            $sql[] = "INSERT INTO `options_meta` VALUES(26, 'admissions_email', 'admissions@colegio.edu');";

            $sql[] = "INSERT INTO `options_meta` VALUES(27, 'coa_form_text', '<p>Dear Admin,</p>\r\n<p>#name# has submitted a change of address. Please see below for details.</p>\r\n<p><strong>ID:</strong> #id#</p>\r\n<p><strong>Address1:</strong> #address1#</p>\r\n<p><strong>Address2:</strong> #address2#</p>\r\n<p><strong>City:</strong> #city#</p>\r\n<p><strong>State:</strong> #state#</p>\r\n<p><strong>Zip:</strong> #zip#</p>\r\n<p><strong>Country:</strong> #country#</p>\r\n<p><strong>Phone:</strong> #phone#</p>\r\n<p><strong>Email:</strong> #email#</p>\r\n<p>&nbsp;</p>\r\n<p>----<br /><em>This is a system generated email.</em></p>');";

            $sql[] = "INSERT INTO `options_meta` VALUES(28, 'enable_myet_appl_form', '0');";

            $sql[] = "INSERT INTO `options_meta` VALUES(29, 'myet_offline_message', 'Please excuse the dust. We are giving the portal a new facelift. Please try back again in an hour.\r\n\r\nSincerely,\r\nIT Department');";

            $sql[] = "INSERT INTO `options_meta` VALUES(30, 'curl', '1');";
            
            $sql[] = "INSERT INTO `options_meta` VALUES(31, 'system_timezone', 'America/New_York');";
            
            $sql[] = "INSERT INTO `cronjob` VALUES(1, '" . url('/') . "cron/activityLog/', 'Purge Activity Log', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(2, '" . url('/') . "cron/runStuTerms/', 'Create Student Terms Record', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(3, '" . url('/') . "cron/runStuLoad/', 'Create Student Load Record', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(4, '" . url('/') . "cron/updateStuTerms/', 'Update Student Terms', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(5, '" . url('/') . "cron/updateStuLoad/', 'Update Student Load', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(6, '" . url('/') . "cron/runEmailHold/', 'Process Email Hold Table', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(7, '" . url('/') . "cron/runEmailQueue/', 'Process Email Queue', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(8, '" . url('/') . "cron/purgeEmailHold/', 'Purge Email Hold', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(9, '" . url('/') . "cron/purgeEmailQueue/', 'Purge Email Queue', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(10, '" . url('/') . "cron/runGraduation/', 'Process Graduation', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(11, '" . url('/') . "cron/runTermGPA/', 'Create Student Term GPA Record', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(12, '" . url('/') . "cron/updateTermGPA/', 'Update Term GPA', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(13, '" . url('/') . "cron/purgeErrorLog/', 'Purge Error Log', NULL, 0, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(14, '" . url('/') . "cron/purgeSavedQuery/', 'Purge Saved Queries', 86400, 1380595419, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(15, '" . url('/') . "cron/purgeCronLogs/', 'Purge Cron Logs', 86400, 1380595404, 0, 0, 0);";

            $sql[] = "INSERT INTO `cronjob` VALUES(16, '" . url('/') . "cron/runDBBackup/', 'Backup Database', NULL, 0, 0, 0, 0);";
