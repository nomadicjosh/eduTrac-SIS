...
<div class="innerLR">
	...
	<!-- Form -->
	<form class="form-horizontal margin-none" action="<?=url('/');?>v1/school/" id="validateSubmitForm" method="post" autocomplete="off">
                    ...
                    <td class="text-center">
                    	<div class="btn-group dropup">
                            ...
                            <ul role="menu" class="dropdown-menu dropup-text pull-right">
                                <li><a href="<?=url('/');?>form/view-school/<?=_h($value['schoolID']);?>/<?=bm();?>"><?=_t( 'View' ); ?></a></li>
