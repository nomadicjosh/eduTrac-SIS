...
<div class="innerLR">
    ...
    <!-- Form -->
    <form class="form-horizontal margin-none" action="<?=url('/');?>v1/term/" id="validateSubmitForm" method="post" autocomplete="off">
                    ...
                    <td class="text-center">
                        <div class="btn-group dropup">
                            ...
                            <ul role="menu" class="dropdown-menu dropup-text pull-right">
                                <li><a href="<?=url('/');?>form/view-term/<?=_h($value['termID']);?>/<?=bm();?>"><?=_t( 'View' ); ?></a></li>
                                <?php $app->hook->{'do_action'}('search_term_action'); ?>
                            </ul>
                        </div>
                    </td>
                </tr>
