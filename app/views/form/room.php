...
<div class="innerLR">
	...
	<!-- Form -->
	<form class="form-horizontal margin-none" action="<?=get_base_url();?>form/room/" id="validateSubmitForm" method="post" autocomplete="off">
                    ...
                    <td class="text-center">
                    	<div class="btn-group dropup">
                            ...
                            <ul role="menu" class="dropdown-menu dropup-text pull-right">
                                <li><a href="<?=get_base_url();?>form/room/<?=_h($value['roomID']);?>/<?=bm();?>"><?=_t( 'View' ); ?></a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
