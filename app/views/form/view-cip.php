...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><a href="<?=get_base_url();?>form/cip/" class="glyphicons pin_flag"><i></i> <?=_t( 'CIP' );?></a></li>
	<li class="divider"></li>
	<li><?=_t( 'View CIP' );?></li>
</ul>
...
<div class="innerLR">
	...
	<!-- Form -->
	<form class="form-horizontal margin-none" action="<?=get_base_url();?>form/cip/<?=_h($cip[0]['id']);?>/" id="validateSubmitForm" method="post" autocomplete="off">
		...
		<div class="widget widget-heading-simple widget-body-gray <?=($app->hook->has_filter('sidebar_menu')) ? 'col-md-12' : 'col-md-10';?>">
			...
			<div class="widget-body">
				...
				<div class="form-actions">
					...
					<button type="button" class="btn btn-icon btn-primary glyphicons circle_minus" onclick="window.location='<?=get_base_url();?>form/cip/'"><i></i><?=_t( 'Cancel' );?></button>
				</div>
				<!-- // Form actions END -->
