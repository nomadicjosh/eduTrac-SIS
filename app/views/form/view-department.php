...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><a href="<?=get_base_url();?>form/department/<?=bm();?>" class="glyphicons pin_flag"><i></i> <?=_t( 'Department' );?></a></li>
	<li class="divider"></li>
...
<div class="innerLR">
	...
	<!-- Form -->
	<form class="form-horizontal margin-none" action="<?=get_base_url();?>form/department/<?=_h($dept[0]['deptID']);?>/" id="validateSubmitForm" method="post" autocomplete="off">
		...
		<div class="widget widget-heading-simple widget-body-gray <?=($app->hook->has_filter('sidebar_menu')) ? 'col-md-12' : 'col-md-10';?>">
			...
			<div class="widget-body">
				...
				<div class="form-actions">
					...
					<button type="button" class="btn btn-icon btn-primary glyphicons circle_minus" onclick="window.location='<?=get_base_url();?>form/department/<?=bm();?>'"><i></i><?=_t( 'Cancel' );?></button>
				</div>
				<!-- // Form actions END -->
