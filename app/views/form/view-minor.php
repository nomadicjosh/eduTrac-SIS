...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><a href="<?=get_base_url();?>form/minor/" class="glyphicons pin_flag"><i></i> <?=_t( 'Minor' );?></a></li>
	<li class="divider"></li>
	<li><?=_t( 'View Minor' );?></li>
</ul>
		...
		<div class="widget widget-heading-simple widget-body-gray <?=($app->hook->has_filter('sidebar_menu')) ? 'col-md-12' : 'col-md-10';?>">
			...
			<div class="widget-body">
				...
				<div class="form-actions">
					...
					<button type="button" class="btn btn-icon btn-primary glyphicons circle_minus" onclick="window.location='<?=get_base_url();?>form/minor/'"><i></i><?=_t( 'Cancel' );?></button>
				</div>
				<!-- // Form actions END -->
