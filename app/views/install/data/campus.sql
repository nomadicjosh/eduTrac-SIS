...
ALTER TABLE `stu_acct_fee` ADD CONSTRAINT saf_fk_termCode FOREIGN KEY (`termCode`) REFERENCES `termCode` (`termCode`) ON UPDATE CASCADE;
...
ALTER TABLE `stu_acct_tuition` ADD CONSTRAINT sat_fk_termCode FOREIGN KEY (`termCode`) REFERENCES `termCode` (`termCode`) ON UPDATE CASCADE;
