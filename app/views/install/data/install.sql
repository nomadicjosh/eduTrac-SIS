...
INSERT INTO `acad_year` VALUES(1, 'NULL', 'Null', '2014-02-26 21:43:26');
...
INSERT INTO `ccd` VALUES(1, 'NULL', 'Null', '2014-02-26', '2014-02-26 21:45:05');
...
INSERT INTO `cip` VALUES(1, 'NULL', 'Null', '2014-02-26 21:46:09');
...
INSERT INTO `degree` VALUES(1, 'NULL', '', '2014-02-26 22:28:44');
...
INSERT INTO `grade_scale` VALUES(1, 'A+', '97-100', '4.00', '1', '1', '');

INSERT INTO `grade_scale` VALUES(2, 'A', '93-96', '4.00', '1', '1', '');

INSERT INTO `grade_scale` VALUES(3, 'A-', '90-92', '3.70', '1', '1', '');

INSERT INTO `grade_scale` VALUES(4, 'B+', '87-89', '3.30', '1', '1', '');

INSERT INTO `grade_scale` VALUES(5, 'B', '83-86', '3.00', '1', '1', '');

INSERT INTO `grade_scale` VALUES(6, 'B-', '80-82', '2.70', '1', '1', '');

INSERT INTO `grade_scale` VALUES(7, 'P', '80-82', '2.70', '1', '1', 'Minimum for Pass/Fail courses');

INSERT INTO `grade_scale` VALUES(8, 'C+', '77-79', '2.30', '1', '1', '');

INSERT INTO `grade_scale` VALUES(9, 'C', '73-76', '2.00', '1', '1', '');

INSERT INTO `grade_scale` VALUES(10, 'C-', '70-72', '1.70', '1', '1', '');

INSERT INTO `grade_scale` VALUES(11, 'D+', '67-69', '1.30', '1', '1', '');

INSERT INTO `grade_scale` VALUES(12, 'D', '65-66', '1.00', '1', '1', '');

INSERT INTO `grade_scale` VALUES(13, 'F', 'Below 65', '0.00', '1', '1', '');

INSERT INTO `grade_scale` VALUES(14, 'I', '0', '0.00', '0', '1', 'Incomplete grades');

INSERT INTO `grade_scale` VALUES(15, 'AW', '0', '0.00', '0', '1', '"AW" is an administrative grade assigned to students who have attended no more than the first two classes, but who have not officially dropped or withdrawn from the course. Does not count against GPA.');

INSERT INTO `grade_scale` VALUES(16, 'NA', '0', '0.00', '0', '1', '"NA" is an administrative grade assigned to students who are officially registered for the course and whose name appears on the grade roster, but who have never attended class. Does not count against GPA.');

INSERT INTO `grade_scale` VALUES(17, 'W', '0', '0.00', '0', '1', 'Withdrew');

INSERT INTO `grade_scale` VALUES(18, 'IP', '90-98', '4.00', '0', '1', 'Incomplete passing');
...
INSERT INTO `location` VALUES(1, 'NULL', '', '2014-02-26 22:06:17');
...
INSERT INTO `major` VALUES(1, 'NULL', '', '2014-02-26 22:07:30');
...
INSERT INTO `minor` VALUES(1, 'NULL', '', '2014-02-26 22:07:59');
...
INSERT INTO `nslc_setup` VALUES(1, '00', '13/FA', '2013-09-01', '2013-12-18');
...
INSERT INTO `pay_grade` VALUES('', '24', '40000.00', '44999.00', '2014-09-01', 00000001, '2014-09-01');
...
INSERT INTO `room` VALUES(1, 'NULL', 'NULL', '', 0);
...
INSERT INTO `school` VALUES(1, 'NULL', 'NULL', 'NULL', '2014-02-26 22:13:31');
...
INSERT INTO `semester` VALUES(1, 'NULL', 'NULL', '', '2014-02-26', '2014-02-26', '1');
...
INSERT INTO `specialization` VALUES(1, 'NULL', '');
...
INSERT INTO `subject` VALUES(00000000001, 'NULL', '', '2014-02-26 22:16:38');
...
INSERT INTO `term` VALUES(1, 'NULL', 'NULL', '', '', '0000-00-00', '0000-00-00', '0000-00-00', '1');
...
ALTER TABLE `assignment` ADD FOREIGN KEY (`courseSecCode`) REFERENCES `course_sec` (`courseSecCode`) ON UPDATE CASCADE;

ALTER TABLE `assignment` ADD FOREIGN KEY (`termCode`) REFERENCES `term` (`termCode`) ON UPDATE CASCADE;

ALTER TABLE `attendance` ADD FOREIGN KEY (`stuID`) REFERENCES `student` (`stuID`) ON UPDATE CASCADE;

ALTER TABLE `attendance` ADD FOREIGN KEY (`termCode`) REFERENCES `term` (`termCode`) ON UPDATE CASCADE;

ALTER TABLE `attendance` ADD FOREIGN KEY (`courseSecCode`) REFERENCES `course_sec` (`courseSecCode`) ON UPDATE CASCADE;
...
ALTER TABLE `gradebook` ADD FOREIGN KEY (`termCode`) REFERENCES `term` (`termCode`) ON UPDATE CASCADE;
