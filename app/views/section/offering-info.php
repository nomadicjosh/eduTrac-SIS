...
<div class="innerLR">
	...
	<!-- Form -->
	<form class="form-horizontal margin-none" action="<?=get_base_url();?>sect/soff/<?=_h($sect[0]['courseSecID']);?>/" id="validateSubmitForm" method="post" autocomplete="off">
		...
		<div class="widget widget-heading-simple widget-body-gray <?=(has_filter('sidebar_menu')) ? 'col-md-12' : 'col-md-10';?>">
            ...
            <div class="tabsbar">
                <ul>
                    ...
                    <li class="glyphicons more_items tab-stacked active"><a href="<?=get_base_url();?>sect/soff/<?=_h($sect[0]['courseSecID']);?>/<?=bm();?>" data-toggle="tab"><i></i> <?=_t( 'Offering Info' );?></a></li>
