...
<div class="innerLR">
	...
	<!-- Form -->
	<form class="form-horizontal margin-none" action="<?=url('/');?>sql/saved-queries/<?=_h($query[0]['savedQueryID']);?>/" id="validateSubmitForm" method="post">
		...
		<div class="widget widget-heading-simple widget-body-gray">
            ...
            <div class="tabsbar">
                <ul>
                    ...
                    <li class="glyphicons disk_saved tab-stacked active"><a href="<?=url('/');?>sql/saved-queries/"><i></i> <?=_t( 'Saved Queries' );?></a></li>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" name="savedQueryName" class="form-control" value="<?=_h($query[0]['savedQueryName']);?>" required/>
							</div>
						</div>
						<!-- // Group END -->
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<textarea id="mustHaveId" class="form-control" rows="5" style="width:65em;" name="savedQuery" required><?=_escape($query[0]['savedQuery']);?></textarea>
							</div>
						</div>
						<!-- // Group END -->
						...
						<div class="form-group">
                            ...
                            <div class="col-md-8 uniformjs">
                                <label class="radio">
                                    <input type="radio" name="purgeQuery" class="radio" value="1" <?=checked(_h($query[0]['purgeQuery']), '1', false);?> />Yes
                                </label>
                                <br />
                                <label class="radio">
                                    <input type="radio" name="purgeQuery" class="radio" value="0" <?=checked(_h($query[0]['purgeQuery']), '0', false);?> />No &nbsp;
