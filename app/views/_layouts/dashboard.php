        ...
        <div class="container-fluid fluid">
            ...
            <div id="content">
                            ...
                            <ul class="dropdown-menu pull-left">
                                ...
                                <li<?= hl('settings', 'edit_settings'); ?> class="dropdown submenu">
                                    ...
                                    <ul class="dropdown-menu submenu-show submenu-hide pull-right">
                                        ...
                                        <li<?= hl('automatic_update', 'edit_settings'); ?>><a href="<?= get_base_url(); ?>dashboard/update/<?= bm(); ?>"> <?= _t('Automatic Update'); ?></a></li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="dropdown-menu submenu-show submenu-hide pull-right">
                                        ...
                                        <li<?= ae('access_course_sec_screen'); ?> class="dropdown submenu">
                                            ...
                                            <ul class="dropdown-menu submenu-show submenu-hide pull-right">
                                                ...
                                                <li<?= ae('access_grading_screen'); ?><?= ml('gradebook_module'); ?>><a href="<?= get_base_url(); ?>sect/courses/<?= bm(); ?>"><?= _t('My Course Sections'); ?></a></li>
                                            </ul>
                                        </li>
                ...
                <div id="custom-footer" class="hidden-print">
                    ...
                    <!--  Copyright Line -->
                    <div class="copy"><?= _t('&copy; 2013'); ?> - <?php release(); ?> &nbsp; <a href="http://www.litenframework.com/"><img src="<?= get_base_url(); ?>static/assets/images/button.png" alt="Built with Liten Framework"/></a></div>
                    <!--  End Copyright Line -->
