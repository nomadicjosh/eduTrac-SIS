                ...
                <div class="modal fade" id="status">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<!-- // Modal heading END -->
		                    <div class="modal-body">
		                        <p><?=_t( "If the person has a student or staff record, the status set here will be set on those records as well. Please note that setting the status to inactive will prohibit login." );?></p>
		                    </div>
		                    <div class="modal-footer">
		                        <a href="#" data-dismiss="modal" class="btn btn-primary"><?=_t( 'Cancel' );?></a>
		                    </div>
