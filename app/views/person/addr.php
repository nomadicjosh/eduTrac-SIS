...
<ul class="breadcrumb">
    ...
    <li class="divider"></li>
    <li><a href="<?=get_base_url();?>nae/<?=_escape($addr[0]['personID']);?>/" class="glyphicons user"><i></i> <?=get_name(_escape((int)$addr[0]['personID']));?></a></li>
    <li class="divider"></li>
    <li><a href="<?=get_base_url();?>nae/adsu/<?=_escape($addr[0]['personID']);?>/" class="glyphicons vcard"><i></i> <?=_t( 'Address Summary' );?></a></li>
    <li class="divider"></li>
	<li><?=_t( 'Edit Address' );?></li>
</ul>

<h3 class="hidden-print"><?=get_name(_escape((int)$addr[0]['personID']));?></h3>
<div class="innerLR">
	...
	<!-- Form -->
	<form class="form-horizontal margin-none grid-form" action="<?=get_base_url();?>nae/addr/<?=_escape($addr[0]['id']);?>/" id="validateSubmitForm" method="post" autocomplete="off">
		...
		<div class="widget widget-heading-simple widget-body-white <?=($app->hook->has_filter('sidebar_menu')) ? 'col-md-12' : 'col-md-10';?>">
			...
			<div class="widget-body">
                ...
                <fieldset>
                    ...
                    <div data-row-span="2">
                        <div data-field-span="1">
                            ...
                            <input type="text" name="address1"<?=aio();?> value="<?=_escape($addr[0]['address1']);?>" required/>
                        </div>
                        <div data-field-span="1">
                            <label><?=_t( 'Address2' );?></label>
                            <input type="text" name="address2"<?=aio();?> value="<?=_escape($addr[0]['address2']);?>" />
                        </div>
                    </div>
                    <div data-row-span="4">
                        <div data-field-span="1">
                            <label><font color="red">*</font> <?=_t( 'City' );?></label>
                            <input type="text" name="city"<?=aio();?> value="<?=_escape($addr[0]['city']);?>" required />
                        </div>
                        <div data-field-span="1">
                            ...
                            <select name="state" class="selectpicker form-control" data-style="btn-info" data-size="10" data-live-search="true">
                                <option value="">&nbsp;</option>
                                <?php table_dropdown('state',null,'code','code','name',_escape($addr[0]['state'])); ?>
                            </select>
                        </div>
                        <div data-field-span="1">
                            <label><?=_t( 'Zip/Postal Code' );?></label>
                            <input type="text" name="zip"<?=aio();?> value="<?=_escape($addr[0]['zip']);?>" />
                        </div>
                        <div data-field-span="1">
                            ...
                            <select name="country" class="selectpicker form-control" data-style="btn-info" data-size="10" data-live-search="true">
                                <option value="">&nbsp;</option>
                                <?php table_dropdown('country',null,'iso2','iso2','short_name',_escape($addr[0]['country'])); ?>
                            </select>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div data-row-span="4">
                        <div data-field-span="1">
                            ...
                            <?=address_type_select(_escape($addr[0]['addressType']));?>
                        </div>
                        <div data-field-span="1">
                            <label><font color="red">*</font> <?=_t( 'Start Date' );?></label>
                            <div class="input-group date col-md-8" id="datepicker6">
                                <input name="startDate"<?=aio();?> type="text" value="<?=_escape($addr[0]['startDate']);?>" required/>
                        ...
                        <div data-field-span="1">
                            ...
                            <?=address_status_select(_escape($addr[0]['addressStatus']));?>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div data-row-span="3">
                        <div data-field-span="1">
                            ...
                            <input type="text" name="phone1"<?=aio();?> value="<?=_escape($addr[0]['phone1']);?>" />
                        </div>
                        <div data-field-span="1">
                            <label><?=_t( 'Extension1' );?></label>
                            <input type="text" name="ext1"<?=aio();?> value="<?=_escape($addr[0]['ext1']);?>" />
                        </div>
                        <div data-field-span="1">
                            ...
                            <select name="phoneType1" class="selectpicker col-md-8" data-style="btn-info" data-size="10" data-live-search="true"<?=aio();?>>
                                <option value="">&nbsp;</option>
                                <option value="BUS"<?=selected(_escape($addr[0]['phoneType1']),'BUS',false);?>><?=_t( 'Business' );?></option>
                                <option value="CEL"<?=selected(_escape($addr[0]['phoneType1']),'CEL',false);?>><?=_t( 'Cellular' );?></option>
                                <option value="H"<?=selected(_escape($addr[0]['phoneType1']),'H',false);?>><?=_t( 'Home' );?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div data-row-span="3">
                        <div data-field-span="1">
                            ...
                            <input type="text" name="phone2"<?=aio();?> value="<?=_escape($addr[0]['phone2']);?>" />
                        </div>
                        <div data-field-span="1">
                            <label><?=_t( 'Extension2' );?></label>
                            <input type="text" name="ext2"<?=aio();?> value="<?=_escape($addr[0]['ext2']);?>" />
                        </div>
                        <div data-field-span="1">
                            ...
                            <select name="phoneType2" class="selectpicker col-md-8" data-style="btn-info" data-size="10" data-live-search="true"<?=aio();?>>
                                <option value="">&nbsp;</option>
                                <option value="BUS"<?=selected(_escape($addr[0]['phoneType2']),'BUS',false);?>><?=_t( 'Business' );?></option>
                                <option value="CEL"<?=selected(_escape($addr[0]['phoneType2']),'CEL',false);?>><?=_t( 'Cellular' );?></option>
                                <option value="H"<?=selected(_escape($addr[0]['phoneType2']),'H',false);?>><?=_t( 'Home' );?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div data-row-span="2">
                        <div data-field-span="1" class="readonly">
                            ...
                            <input type="email" readonly value="<?=_escape($addr[0]['email1']);?>" />
                        </div>
                        <div data-field-span="1">
                            <label><?=_t( 'Secondary Email' );?></label>
                            <input type="email" name="email2"<?=aio();?> value="<?=_escape($addr[0]['email2']);?>" />
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div data-row-span="2">
                        <div data-field-span="1" class="readonly">
                            ...
                            <input type="text" readonly value="<?=\Jenssegers\Date\Date::parse(_escape($addr[0]['addDate']))->format('D, M d, o');?>" />
                        </div>
                        <div data-field-span="1" class="readonly">
                            <label><?=_t( 'Added By' );?></label>
                            <input type="text" readonly value="<?=get_name(_escape((int)$addr[0]['addedBy']));?>" />
                        </div>
                    </div>
                </fieldset>
				...
				<div class="form-actions hidden-print">
                    ...
                    <button type="button" class="btn btn-icon btn-primary glyphicons circle_minus" onclick="window.location='<?=get_base_url();?>nae/adsu/<?=_escape($addr[0]['personID']);?>/'"><i></i><?=_t( 'Cancel' );?></button>
				</div>
				<!-- // Form actions END -->
