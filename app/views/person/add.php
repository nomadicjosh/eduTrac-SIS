				...
				<div class="row">
					...
					<div class="col-md-6">
                        ...
                        <?php 
                             ...
                             * @since 6.1.10
                             */
                            $app->hook->do_action('left_nae_new_form'); 
                        ?>
					...
					<div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" type="email" name="email" value="<?=(isset($_POST['email'])) ? $_POST['email'] : '';?>" required/>
                            </div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <?php 
                             ...
                             * @since 6.1.10
                             */
                            $app->hook->do_action('right_nae_new_form'); 
                        ?>
