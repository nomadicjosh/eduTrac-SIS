...
<div class="innerLR">
	...
	<!-- Form -->
	<form class="form-horizontal margin-none" action="<?=get_base_url();?>dashboard/sms/" id="validateSubmitForm" method="post" autocomplete="off">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><font color="red">*</font> <?=_t( 'Group' );?></label>
							<div class="col-md-8">
					...
					<div class="col-md-6">
						...
						<!-- Group -->
                        <div class="form-group">
                            <label class="col-md-3 control-label"><font color="red">*</font> <?=_t( "Text" );?></label>
                            <div class="col-md-8">
                                <textarea name="sms_text" class="form-control" rows="5" required></textarea>
                            </div>
                        </div>
                        <!-- // Group END -->
