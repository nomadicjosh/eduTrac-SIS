...
class etsis_AutoUpdate
{
    ...
    public function __construct($tempDir = null, $installDir = null, $maxExecutionTime = 60)
    {
        ...
        $this->setTempDir(($tempDir !== null) ? $tempDir : __DIR__ . DS . 'temp' . DS);
        $this->setInstallDir(($installDir !== null) ? $installDir : __DIR__ . DS . '..' . DS . '..' . DS);
    ...
    public function checkUpdate()
    {
        ...
        if ($versions === false) {
            ...
            $updateFile = $this->_updateUrl . DS . $this->_updateFile;
