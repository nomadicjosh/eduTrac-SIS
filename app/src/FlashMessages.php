...
class FlashMessages
{
     ...
     *
     * @param mixed $types
     *            (null) print all of the message types
    ...
    protected function formatMessage($msgDataArray, $type)
    {
        ...
        return sprintf($this->msgWrapper, $cssClass, $formattedMessage);
    }
     ...
     *
     * @param mixed $types
     *            (array) Clear all of the message types in array
     ...
     *            The HTML that each message is wrapped in.
