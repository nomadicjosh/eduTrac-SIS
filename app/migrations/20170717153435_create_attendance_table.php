...
class CreateAttendanceTable extends AbstractMigration
{
    ...
    public function change()
    {
        ...
        if (!$this->hasTable('attendance')) :
            $table = $this->table('attendance', ['id' => false, 'primary_key' => 'id', 'encoding' => 'utf8mb4', 'collation' => 'utf8mb4_unicode_ci']);
            $table
                ...
                ->addIndex(['courseSecID', 'stuID', 'date', 'status'], ['unique' => true])
                ->addForeignKey('courseSecID', 'course_sec', 'courseSecID', ['constraint' => 'attendance_courseSecID', 'delete' => 'CASCADE', 'update' => 'CASCADE'])
                ->addForeignKey('stuID', 'student', 'stuID', ['constraint' => 'attendance_stuID', 'delete' => 'CASCADE', 'update' => 'CASCADE'])
                ->addForeignKey('facID', 'staff', 'staffID', ['constraint' => 'attendance_facID', 'delete' => 'CASCADE', 'update' => 'CASCADE'])
                ->create();
        endif;
