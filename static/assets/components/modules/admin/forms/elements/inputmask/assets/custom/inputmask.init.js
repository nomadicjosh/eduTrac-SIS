$(function()
{
    ...
    if ($('[id^="inputmask-decimal_"]').length)
	$('[id^="inputmask-decimal_"]').inputmask('decimal', { rightAlignNumerics: false });
    ...
    $("#inputmask-int").inputmask("integer", {numericInput: true, rightAlignNumerics: false});
